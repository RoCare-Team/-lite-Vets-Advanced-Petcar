...
export const metadata = pageMetadata({
  ...
  description:
    "Contact The Élite Vets Advanced Petcare, DSS 107 & 108 Huda Market, Sector 45 Gurugram. Call +91 92663 95550 or 0124-4141348, email theelitevets@gmail.com, or book on WhatsApp.",
  path: "/contact",
});
  ...
  return (
    <>
      <PageHero
        ...
        description="We're here 24/7 for emergencies. For consultations, send us a request and our team will confirm your visit."
      ...
      <section aria-labelledby="appointment-heading" className="bg-cream pt-16 lg:pt-24">
        <div className="container-x">
          <div className="rounded-panel border border-line bg-white p-6 shadow-soft sm:p-10 lg:p-12">
            <p className="eyebrow">
              <span aria-hidden="true" className="h-px w-6 bg-teal/60" /> Appointment request
            </p>
            <h2 id="appointment-heading" className="mt-4 text-3xl font-bold sm:text-4xl">
              Book an appointment
            </h2>
            <p className="mt-3 max-w-2xl text-muted">
              Share a few details and we&apos;ll get back to you on WhatsApp to confirm a time.
            </p>
            <div className="mt-8">
              <AppointmentForm />
            </div>
