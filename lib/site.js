...
export const mainNav = [
  { label: "Élite Home", href: "/" },
  { label: "Élite About", href: "/about" },
  { label: "Élite Services", href: "/services", mega: true },
  { label: "Élite Gallery", href: "/gallery" },
  { label: "Élite Team", href: "/team" },
  { label: "Élite Contact", href: "/contact" },
];

// Pet parent portal — still hosted on the previous site until the new one is built.
export const petPortal = {
  login: "https://theelitevets.in/admin/login.php",
  register: "https://theelitevets.in/admin/signup.php",
};
